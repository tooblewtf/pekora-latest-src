...
function DeveloperConsole.new(screenGui, permissions, messagesAndStats)
	...
	do -- Create top right exit button
		local exitButton, exitButtonImage = createCornerButton('Exit', 1, 0, 'http://www.silrev.biz/asset/?id=261878266', 2/3)
	...
	do -- Repositioning and Resizing
		...
		do -- Create bottom right window resize button and activate resize dragging
			local resizeButton, resizeButtonImage = createCornerButton('Resize', 1, 1, 'http://www.silrev.biz/asset/?id=261880743', 1)
	...
	do -- Options animation
		...
		local gear = Primitives.InvisibleImageLabel(optionsButton, 'Image', 'http://www.silrev.biz/asset/?id=261882463')
...
function Methods.CreateScrollbar(devConsole, rotation)
	...
	local buttonUp = Primitives.ImageButton(frame, 'Up', 'http://www.silrev.biz/asset/?id=261880783')
	...
	local buttonDown = Primitives.ImageButton(frame, 'Down', 'http://www.silrev.biz/asset/?id=261880783')
	...
	local grip = Primitives.InvisibleImageLabel(bar, 'Image', 'http://www.silrev.biz/asset/?id=261904959')
